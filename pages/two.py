...
openai.api_key = "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"
...
def outline_text(text):
    ...
    prompt = (
        ...
        "The outline should contain no more than five main points, with each point described in one sentence."
    )
    model = "text-davinci-003" # You can choose a different GPT-3 model if you prefer
